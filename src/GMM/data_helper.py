...
def load_samples_data(train1_path='data/Train1.csv', train2_path='data/Train2.csv'):
    """
    load Train1 and Train2 data.
    :param train1_path:
    :param train2_path:
    :return:
    """
    with open(train1_path, 'r') as f1:
        lines = csv.reader(f1)
        train1_data = list(lines)

    with open(train2_path, 'r') as f2:
        lines = csv.reader(f2)
        train2_data = list(lines)
    return np.array(train1_data, dtype="float64"), np.array(train2_data, dtype='float64')


def load_samples_test_data(test1_path='data/Test1.csv', test2_path='data/Test2.csv'):
    """
    load Test1 data and Test2 data.
    :param test1_path:
    :param test2_path:
    :return:
    """
    with open(test1_path, 'r') as f1:
        lines = csv.reader(f1)
        test1_data = list(lines)

    with open(test2_path, 'r') as f2:
        lines = csv.reader(f2)
        test2_data = list(lines)
...
if __name__ == "__main__":
    train1_data, train2_data = load_samples_data()
    print(train1_data)
    print()
    print(train2_data)
